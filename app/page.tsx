          ...
          {submitted ? (
            ...
            waitlistDone ? (
              ...
              <>
                <h1 className="text-4xl sm:text-5xl font-bold text-white leading-tight mb-4">
                  The Free 10-Second Creator Hook Generator: Write Top 1% Viral Hooks
                </h1>
            ...
            <>
              ...
              <p className="text-[#9CA3AF] text-base sm:text-lg leading-relaxed mb-6">
                Used and trained by the Top 1% Streamers and Creators. Limited free access spots open each week. If we are sold out, please join the waitlist.
              </p>
